...
GROUPS = {
    "Group A - 👇Select Category💦🥵": [
   "Main CP DEMO",
    "Indian r##p MMS Leaked",
    "Chi$#dd mms leaked DEMO",
    ...
    "Group B - 👇Select Category💦🥵": [
    "Desi Flashing Demo",
    "Full Open Dance demo",
    "Dress Change Demo",
    "Aditiy Mistry Demo",
    "Full Webseries Demo",
    "Desi Moti Gand Walking Demo",
    "Teen CP Demo",
    ],
    "Group C - 👇Select Category💦🥵": [
    "Mom and Daughter CP Demo",
    "Foreign CP Demo",
    "Tamil CP Demo",
    "𝗙𝗼𝗿𝗰𝗲𝗱 𝘀𝗲𝘅 CP Demo",
    "𝗜𝗻𝗱𝗶𝗮𝗻 𝗽𝗲𝗱𝗼𝗺𝗼𝗺 CP Demo",
    "𝗦𝗽𝘆 𝗰𝗮𝗺𝗲𝗿𝗮 CP Demo",
    "𝗜𝗻𝗱𝗶𝗮𝗻 𝗚𝗮𝘆 𝘃𝗶𝗱𝗲𝗼𝘀 CP Demo",
    "𝗜𝗻𝗱𝗶𝗮𝗻 𝗟𝗲𝘀𝗯𝗶𝗮𝗻𝘀 CP Demo",
    "𝗠𝘂𝘀𝗹𝗶𝗺 𝘃𝗶𝗱𝗲𝗼𝘀 CP Demo",
    ],
    "Group D - 👇Select Category💦🥵": [
   "𝗦𝗹𝗲𝗲𝗽𝗶𝗻𝗴 𝘀𝗲𝘅 𝘃𝗶𝗱𝗲𝗼𝘀 CP Demo",
    "𝗛𝗶𝗱𝗱𝗲𝗻 𝗖𝗮𝗺 𝘃𝗶𝗱𝗲𝗼𝘀 CP Demo",
    "𝗥𝗲𝗱 𝗟𝗶𝗴𝗵𝘁 𝗔𝗿𝗲𝗮 CP Demo",
    "𝗠𝗮𝗿𝗮𝘁𝗵𝗶 𝘃𝗶𝗱𝗲𝗼𝘀 CP Demo",
    "𝗜𝗻𝗱𝗶𝗮𝗻 𝗰𝗼𝗹𝗹𝗲𝗴𝗲 𝗴𝗶𝗿𝗹𝘀 CP Demo",
    "𝗧𝗲𝗹𝗴𝘂 𝘃𝗶𝗱𝗲𝗼𝘀 CP Demo",
    "𝗠𝗮𝗹𝗮𝘆𝗮𝗹𝗮𝗺 𝘃𝗶𝗱𝗲𝗼𝘀 CP Demo",
    "𝗞𝗮𝗻𝗻𝗮𝗱𝗮 𝘃𝗶𝗱𝗲𝗼𝘀 CP Demo",
    "𝗙𝗮𝗺𝗶𝗹𝘆 𝗱𝗲𝘀𝗵𝗶 𝗖𝗵𝘂𝗱𝗮𝗶 CP Demo",
    ],
    "Group E - 👇Select Category💦🥵": [
     "𝗖𝗮𝗿𝘁𝗼𝗼𝗻 𝗦𝗲𝘅 CP Demo",
    "𝗠𝘂𝗿𝗱𝗲𝗿 CP Demo",
    "𝗕𝗹𝗮𝗰𝗸𝗺𝗮𝗶𝗹 CP Demo",
    "𝗧𝗵𝗿𝗲𝗲𝘀𝗼𝗺𝗲 CP Demo",
    ...
    "𝗔𝗻𝗶𝗺𝗮𝗹 𝘀𝗲𝘅 CP Demo",
    "Bengli CP Demo",
    "bhajpuri bhabhi CP Demo",
    "All in one CP Demo",
    "All complete Combo Package",
    ],
}
...
CHANNEL_IDS = {
   ...
   "Main CP DEMO": -1004304439937,
    ...
    "𝗙𝗼𝗿𝗰𝗲𝗱 𝘀𝗲𝘅 CP Demo": -1003992861276,
    "𝗜𝗻𝗱𝗶𝗮𝗻 𝗽𝗲𝗱𝗼𝗺𝗼𝗺 CP Demo": -1004407174589,
  "𝗦𝗽𝘆 𝗰𝗮𝗺𝗲𝗿𝗮 CP Demo": -1003991175476,
    "𝗜𝗻𝗱𝗶𝗮𝗻 𝗚𝗮𝘆 𝘃𝗶𝗱𝗲𝗼𝘀 CP Demo": -1003962055558,
    "𝗜𝗻𝗱𝗶𝗮𝗻 𝗟𝗲𝘀𝗯𝗶𝗮𝗻𝘀 CP Demo": -1004367853863,
    "𝗠𝘂𝘀𝗹𝗶𝗺 𝘃𝗶𝗱𝗲𝗼𝘀 CP Demo": -1004422718898,
    # Group D
   "𝗦𝗹𝗲𝗲𝗽𝗶𝗻𝗴 𝘀𝗲𝘅 𝘃𝗶𝗱𝗲𝗼𝘀 CP Demo": -1003874972119,
    "𝗛𝗶𝗱𝗱𝗲𝗻 𝗖𝗮𝗺 𝘃𝗶𝗱𝗲𝗼𝘀 CP Demo": -1004348792016,
    "𝗥𝗲𝗱 𝗟𝗶𝗴𝗵𝘁 𝗔𝗿𝗲𝗮 CP Demo": -1004425078173,
    "𝗠𝗮𝗿𝗮𝘁𝗵𝗶 𝘃𝗶𝗱𝗲𝗼𝘀 CP Demo": -1003946602401,
    "𝗜𝗻𝗱𝗶𝗮𝗻 𝗰𝗼𝗹𝗹𝗲𝗴𝗲 𝗴𝗶𝗿𝗹𝘀 CP Demo": -1003608619479,
    "𝗧𝗲𝗹𝗴𝘂 𝘃𝗶𝗱𝗲𝗼𝘀 CP Demo": -1003978466018,
    "𝗠𝗮𝗹𝗮𝘆𝗮𝗹𝗮𝗺 𝘃𝗶𝗱𝗲𝗼𝘀 CP Demo": -1004307529852,
    "𝗞𝗮𝗻𝗻𝗮𝗱𝗮 𝘃𝗶𝗱𝗲𝗼𝘀 CP Demo": -1004341647237,
    "𝗙𝗮𝗺𝗶𝗹𝘆 𝗱𝗲𝘀𝗵𝗶 𝗖𝗵𝘂𝗱𝗮𝗶 CP Demo": -1004166664219,
    # Group E
      "𝗖𝗮𝗿𝘁𝗼𝗼𝗻 𝗦𝗲𝘅 CP Demo": -1003982098371,
    "𝗠𝘂𝗿𝗱𝗲𝗿 CP Demo": -1004471434839,
    "𝗕𝗹𝗮𝗰𝗸𝗺𝗮𝗶𝗹 CP Demo": -1004290039121,
    "𝗧𝗵𝗿𝗲𝗲𝘀𝗼𝗺𝗲 CP Demo": -1004497293570,
    "𝗚𝗮𝗻𝗴𝗯𝗮𝗻𝗴 CP Demo": -1004406659188,
    "𝗠𝗶𝗮 𝗸𝗵𝗮𝗹𝗶𝗳𝗮 CP Demo": -1004455563939,
    "𝗝𝗮𝗽𝗮𝗻𝗲𝘀𝗲 CP Demo": -1004384040670,
    "𝗔𝗻𝗶𝗺𝗮𝗹 𝘀𝗲𝘅 CP Demo": -1004438650005,
    "Bengli CP Demo": -1004351809459,
    "bhajpuri bhabhi CP Demo": -1004316751594,
